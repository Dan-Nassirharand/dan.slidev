...
- The launch of skynet.v1 in 2016 meant that everyone needed to use CI
  - All the different makefiles expected tools in different locations and even different versions
- Supplier compilers were used everywhere

## V1 Is Born

- Each compiler got a custom makefile
  - Common makefile functions went into [makecommon](https://github.com/geappliances/applcommon.makecommon/blob/master/__makecommon.mk)
  - Common Lua tools are distributed through [makecommon](https://github.com/geappliances/applcommon.makecommon)
  - [targetcommon](https://github.com/geappliances/applcommon.makecommon/blob/master/targetcommon.mk) (inside makecommon) handled all the basic tasks of finding sources and making APLs from parametric data.
...
- Custom Makefiles for each compiler meant a lot of maintenance and long development time
...
- Fast forward a few years and GCC compilers are expected to be used
  - KPIT RX was developed in late 2017
- Since all the `gcc` compilers work the same way, the downsides of V1 were starting to get annoying
...
- `DEFINES`: A GEA specific variable that adds `-D` to the front of any define added to the list.
  ...
  - Lets the user do a preprocessor `#define` but through the CLI
...
- [Generating Rules for source](https://github.com/geappliances/build-tools.gcc-builder/blob/master/worker.mk#L235)
- [Generating Rules for libs](https://github.com/geappliances/build-tools.gcc-builder/blob/master/worker.mk#L198)
- [Capturing flags](https://github.com/geappliances/build-tools.gcc-builder/blob/master/worker.mk#L234)
  - [Making the rules dependent on the flags](https://github.com/geappliances/build-tools.gcc-builder/blob/master/worker.mk#L83)
  - [Being Dependent on the Makefiles](https://github.com/geappliances/build-tools.gcc-builder/blob/master/worker.mk#L83)
- [Generating Libs Rules](https://github.com/geappliances/build-tools.gcc-builder/blob/master/worker.mk#L209C38-L209C50)
- [Creating the Linked Output](https://github.com/geappliances/build-tools.gcc-builder/blob/master/worker.mk#L219)
